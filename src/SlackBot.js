...
const SlackBot = () => (
    <Container text style={{ marginTop: '7em' }}>
        ...
        <Container textAlign="left">
            ...
            /><p></p>
            <p>
                <b>Source Code: </b> <a target="_blank" href="https://github.com/hariDasu/nlp-slack-bot">nlp-slack-bot</a>
                </p>
            <p><a target="_blank" href="http://showd.me/"> Showd.me</a> is a peer-to-peer learning platform that enables employees
              ...
              <p>
                <List bulleted>
                    <List.Item>
                        ...
                        <List.List>
                            <List.Item >Slack Integration:<a target="_blank" href="https://nodejs.org/en/">nodeJS</a></List.Item>
                            <List.Item>Natural Language Processing:<a target="_blank" href="http://www.nltk.org/">Python NLTK3</a></List.Item>
                            <List.Item>Container Orchestration:<a target="_blank" href="https://kubernetes.io/">Kubernetes</a></List.Item>
                        </List.List>
                    </List.Item>
                </List>
            ...
            <p>
                ...
                I used <a target="_blank" href="http://blog.templeton.host/self-training-nlp-enabled-slack-bot-tutorial/">
                ...
                The training data of relevant questions I came up with can be <a target="_blank" href="https://github.com/hariDasu/nlp-slack-bot/blob/master/custom-phrases.json">
                found here</a>. I used the Logistic Regression classifier at the level of the nodeJS API with the <a target="_blank" href="https://github.com/NaturalNode/natural">
                Natural Library </a>
                ...
                <p><br/>
                    I wrote <a target="_blank" href="https://github.com/hariDasu/nlp-slack-bot/blob/master/src/nltk-middleware.js">
                    middleware to parse</a> the message that a user sends to my bot, and using some functional compostion a la <a target="_blank" href="http://ramdajs.com/">
                    Ramda.js</a>, I am able to make a <a target="_blank" href="https://github.com/hariDasu/nlp-slack-bot/blob/master/src/nltk-middleware.js#L21"> method call to my Python Code </a>
                    ...
                    which use the 'skill' that is returned from the Logistic regression classifier in Natural and called as a function in my <a target="_blank" href="https://github.com/hariDasu/nltk-python/blob/master/nltkServer.py">
                    python NLTK file</a>.
                    My <a target="_blank" href="https://github.com/hariDasu/nltk-python">nltk-python github repository</a> is created as a submodule within my slackbot github source code.

                </p>

                <Header as="h2">Deployment</Header>
                This project was on <a target="_blank" href="https://cloud.google.com/"> Google Cloud</a> and was Dockerized. In order to manage
                ...
                If I was able to rewrite this project today, I woudl use some of the newer tools I have come across that weren't
                    available to me at the time when I created this projet. <a target="_blank" href="https://api.ai/"> API.AI</a> is a great service that
                    ...
                    deliver a more uniform experience to users. In <a target="_blank" href="https://github.com/hariDasu/lbcbot"> another project I worked on</a>,
                    I used <a target="_blank" href="https://claudiajs.com/claudia-bot-builder.html"> claudiaJS bot builder</a>
                    ...
                    bot doesn't require usage of platform specific components (such as <a target="_blank" href="https://api.slack.com/interactive-messages">
